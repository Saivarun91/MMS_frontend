            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="font-default px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">ID</th>
                    <th className="font-default px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Project ID</th>
                    <th className="font-default px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">User Text</th>
                    <th className="font-default px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Reply Text</th>
                    <th className="font-default px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status</th>
                    <th className="font-default px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">SAP Item</th>
                  ...
                  {filteredRequests.length > 0 ? (
                    filteredRequests.map((request) => (
                      <tr key={request.request_id} className="hover:bg-gray-50">
                        <td className="font-default px-6 py-4 text-sm font-medium text-gray-900">{request.request_id}</td>
                        <td className="px-6 py-4 text-sm text-gray-900">{request.project_id || "N/A"}</td>
                        <td className="px-6 py-4 text-sm text-gray-900 max-w-xs truncate" title={request.user_text}>
                          {request.user_text || "N/A"}
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-900 max-w-xs truncate" title={request.reply_text}>
                          {request.reply_text || "N/A"}
                        </td>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900">{request.sap_item || "N/A"}</td>
                        <td className="px-6 py-4 text-sm text-gray-900">{request.created ? new Date(request.created).toLocaleDateString() : "N/A"}</td>
                        <td className="px-6 py-4 text-sm text-gray-900">
                          <div className="flex space-x-2">
                            <button
                              onClick={() => handleChatUpdate(request)}
                            ...
                            {role === "MDGT" && (
                              <button
                                onClick={() => handleSapAssign(request)}
                                className="text-purple-600 hover:text-purple-800"
                                title="Assign SAP Item"
                              >
                                <Tag size={16} />
                              </button>
                            )}
                            {(role === "Admin" || role === "SuperAdmin" || role === "MDGT") && (
                              <button
